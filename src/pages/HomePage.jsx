...
import { Avatar, Box, Button, Card, CardBody, CardFooter, CardHeader, Divider, Flex, HStack, Heading, Image, SimpleGrid, Text } from "@chakra-ui/react";
  ...
  return (
    ...
    <SimpleGrid p={'10px'} spacing={10} minChildWidth='250px' >
      {Events && Events.map(event => (
        ...
        <Card key={event.id} bg='white' variant='ghost'>
          <Image src={event.img} />
          ...
          <Flex p='4px' mb={3} >
            <Box>
              ...
              <Text>By {event.description}</Text>
            </Box>
          </Flex>
